...
public class AdminController {
	...
	public String recommendation(HttpServletRequest request, Model model) {
		...
		// data.add(new
		// int[]{200703618,200703609,200703608,200703614,200703615,200703610,200673635});
		// data.add(new
		// int[]{200673635,200703610,200703615,200703614,200722371,200703609,200703618,200708065});
		// data.add(new
		// int[]{200703610,200703615,200703609,200708065,200703614,200673635,200703609});
		// data.add(new
		// int[]{200703618,200708065,200703609,200722371,200673635,200703615,200703614});

		// try{
		// Apriori ap = new Apriori(data, 3);
		// ArrayList<SetItem> set =
		// ap.calculateFrequentItemsets(ap.createList());
